lpds <- read.table("LPDS_Rajan.txt", header = TRUE)
lpds0 <- 0
ylim0 <- c(-1390, -1230)
xlim0 <- c(0, 40) 
...
lines(lpds$Knots, lpds$s_moving_plus_a_moving_2-lpds0, type = "o", col = "red", pch = 20)
abline(h = grid.y, v = grid.x, col = "black", lty="dotted", lwd = 0.5)
axis(1, at = at1, lwd = 0.5, labels = FALSE)
## legend(-40, -1280, c("Free surface knots", "Fixed surface knots"), lty = c(1, 1), pch = c(20, NA),
